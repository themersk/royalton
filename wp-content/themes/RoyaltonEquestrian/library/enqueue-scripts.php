...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_register_script( 'foundation', get_template_directory_uri() . '/js/foundation-full.js', array('jquery'), '5.5.2', true );
	
	wp_register_script( 'foundation-equalizer', get_template_directory_uri() . '/js/foundation.equalizer.js', array('jquery'), '5.5.2', true );
